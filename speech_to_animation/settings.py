...
nltk.data.path.append(r'D:\speech to animation\nltk_data')
...
INSTALLED_APPS = [
    ...
    'speech_to_animation',  # Ensure this is included
]
...
ROOT_URLCONF = 'speech_to_animation.urls'
...
WSGI_APPLICATION = 'speech_to_animation.wsgi.application'
